...
<html lang="en">
	...
	<div class="row">
		<div class="col-md-12">
		<form action="<?php echo U('About/save');?>" class="form-horizontal" enctype="multipart/form-data" method="post">

			<div class="form-group">
				<label for="" class="col-sm-2 control-label">公司名：</label>
				<div class="col-sm-4">
					<input  type="text" name="company" class="form-control" value="<?php echo ($vo["company"]); ?>">
				</div>
			</div>
			...
			<div class="form-group" style="">
				...
				<div class="col-sm-4">
					<input type="text" name="tel" class="form-control" value="<?php echo ($vo["tel"]); ?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input  type="text" name="phone" class="form-control" value="<?php echo ($vo["phone"]); ?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input  type="text" name="email" class="form-control" value="<?php echo ($vo["email"]); ?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input  type="text" name="qq" class="form-control" value="<?php echo ($vo["qq"]); ?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input  type="text" name="wechat" class="form-control" value="<?php echo ($vo["wechat"]); ?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input  type="text" name="work_time" class="form-control" value="<?php echo ($vo["work_time"]); ?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input  type="text" name="address" class="form-control" value="<?php echo ($vo["address"]); ?>">
				</div>
			</div>
