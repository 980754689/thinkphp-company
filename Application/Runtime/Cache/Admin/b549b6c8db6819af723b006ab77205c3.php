...
<html lang="en">
	...
	<div class="row">
		<div class="col-md-12">
		<form action="<?php echo U('About/save_1');?>" class="form-horizontal" enctype="multipart/form-data" method="post">

			<div class="form-group">
				<label for="" class="col-sm-2 control-label">公司简介：</label>
				<div class="col-sm-4">
					<textarea style="width:600px;height:200px;margin:10px 3px 10px" name="jianjie"><?php echo ($arr["jianjie"]); ?></textarea>
				</div>
			</div>
