	...
	<h1>
		...
		<table class="table table-striped table-bordered table-hover">
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td><img src="/Public<?php echo ($vo["img"]); ?>" style='width: 40px;height:25px'> </td>
					<td><?php echo ($vo["title"]); ?></td>
					<td><?php echo ($vo["address"]); ?></td>
					<td><?php echo ($vo["area"]); ?></td>
					<td><?php if($vo["type_id"] == 1): ?>商业空间
						<?php elseif($vo["type_id"] == 2): ?>娱乐空间
						<?php elseif($vo["type_id"] == 3): ?>酒店会所
						<?php elseif($vo["type_id"] == 4): ?>住宅空间<?php endif; ?>
					</td>
					...
					<td>
						<a href="<?php echo U('Case/show',array('id'=>$vo['id']));?>">查看</a>
