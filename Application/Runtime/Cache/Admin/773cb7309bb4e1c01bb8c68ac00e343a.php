            ...
            <form action="" class="form-horizontal" enctype="multipart/form-data" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <P style="margin:5px 3px 10px"><?php echo ($vo["title"]); ?></P>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <P style="margin:5px 3px 10px"><?php echo ($vo["content_1"]); ?></P>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <?php }else{ ?>
                            <P style="margin:5px 3px 10px"><?php echo ($vo["num"]); ?></P>
                        <?php }?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <p style="margin:5px 3px 10px"><?php echo ($vo["user_name"]); ?></p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <p style="margin:5px 3px 10px"><?php echo (date("Y-m-d",$vo["created_time"])); ?></p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <p style="margin:5px 3px 10px"><?php echo (date("Y-m-d",$vo["updated_time"])); ?></p>
                    </div>
                </div>
                ...
                <div class="form-group" style="">
                    ...
                    <div class="col-sm-4">
                        <p style="margin:4px 3px 10px"><img src="/Public<?php echo ($vo["img"]); ?>"  style="width:220px;height:165px;"/></p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <P style="margin:5px 3px 10px"><?php echo ($vo["content_2"]); ?></P>
                    </div>
                </div>
