...
<html lang="en">
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="<?php echo U('Case/save');?>" class="form-horizontal" enctype="multipart/form-data" method="post">

                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">案例名称 ：</label>
                    <div class="col-sm-4">
                        <input type="text" name="title" class="form-control" placeholder="" value="<?php echo ($vo["title"]); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="address" class="form-control" placeholder="" value="<?php echo ($vo["address"]); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="area" class="form-control" placeholder="" value="<?php echo ($vo["area"]); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="seat" class="form-control" placeholder="建议填写100/200/300/400或百的倍数"  value="<?php echo ($vo["seat"]); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <!-- <input type="text" name="content" class="form-control" placeholder="" value="<?php echo ($vo["content"]); ?>"> -->
                        <textarea style="width:450px;height:200px;" name="content"><?php echo ($vo["content"]); ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="radio" name="type_id" value="1" <?php if($vo["is_valid"] == 1): ?>checked<?php endif; ?>>商业空间
                        <input type="radio" name="type_id" value="2" <?php if($vo["is_valid"] == 2): ?>checked<?php endif; ?>>娱乐空间
                        <input type="radio" name="type_id" value="3" <?php if($vo["is_valid"] == 3): ?>checked<?php endif; ?>>酒店会所
                        <input type="radio" name="type_id" value="4" <?php if($vo["is_valid"] == 4): ?>checked<?php endif; ?>>住宅空间
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="radio" name="is_valid" value="1" <?php if($vo["is_valid"] == 1): ?>checked<?php endif; ?>>启用
                        <input type="radio" name="is_valid" value="0" <?php if($vo["is_valid"] == 0): ?>checked<?php endif; ?>>禁用
                    </div>
                </div>
                ...
                <div class="form-group" style="">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div id="dd" style=" width:990px;"><img src="/Public<?php echo ($vo["img"]); ?>"  style="width:400px;height:300px;"/></div>
                    </div>
                </div>
