...
<html lang="en">
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="<?php echo U('Advert/save');?>" class="form-horizontal" enctype="multipart/form-data" method="post">
                ...
                <div class="form-group" style="">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div id="dd" style=" width:990px;"><img src="/Public<?php echo ($vo["img"]); ?>"  style="width:810px;height:270px;"/></div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="url" class="form-control" placeholder="" value="<?php echo ($vo["url"]); ?>">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="radio" name="address" value="1" <?php if($vo["address"] == 1): ?>checked<?php endif; ?>>品牌产品
                        <input type="radio" name="address" value="2" <?php if($vo["address"] == 2): ?>checked<?php endif; ?>>案例展示
                        <input type="radio" name="address" value="3" <?php if($vo["address"] == 3): ?>checked<?php endif; ?>>营销活动
                        <input type="radio" name="address" value="4" <?php if($vo["address"] == 4): ?>checked<?php endif; ?>>新闻动态
                        <input type="radio" name="address" value="5" <?php if($vo["address"] == 5): ?>checked<?php endif; ?>>关于我们
                    </div>
                </div>
