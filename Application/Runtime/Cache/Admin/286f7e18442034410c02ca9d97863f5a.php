...
<html lang="en">
	...
	<div class="row">
		<div class="col-md-12">
		<form action="<?php echo U('Copyright/save');?>" class="form-horizontal" enctype="multipart/form-data" method="post">
			...
			<div class="form-group" style="">
				<label for="" class="col-sm-2 control-label">备案时间：</label>
				<div class="col-sm-4">
					<input type="text" name="time" class="form-control" value="<?php echo ($vo["time"]); ?>">
				</div>
			</div>
			
			<div class="form-group">
				<label for="" class="col-sm-2 control-label">查询备案URL：</label>
				<div class="col-sm-4">
					<input  type="text" name="url" class="form-control" value="<?php echo ($vo["url"]); ?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input  type="text" name="ip" class="form-control" value="<?php echo ($vo["ip"]); ?>">
				</div>
			</div>
