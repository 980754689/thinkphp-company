            ...
            <form action="" class="form-horizontal" enctype="multipart/form-data" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <P style="margin:5px 3px 10px"><?php echo ($vo["name"]); ?></P>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <P style="margin:5px 3px 10px"><?php echo ($vo["zhicheng"]); ?></P>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <!-- <textarea style="width:450px;height:100px;" name="content_1"><?php echo ($vo["content_1"]); ?></textarea> -->
                        <P style="margin:5px 3px 10px"><?php echo ($vo["work_time"]); ?></P>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <!-- <textarea style="width:450px;height:100px;" name="content_1"><?php echo ($vo["content_1"]); ?></textarea> -->
                        <P style="margin:5px 3px 10px"><?php echo ($vo["fenge"]); ?></P>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <!-- <textarea style="width:450px;height:100px;" name="content_1"><?php echo ($vo["content_1"]); ?></textarea> -->
                        <P style="margin:5px 3px 10px"><?php echo ($vo["jianjie"]); ?></P>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <!-- <textarea style="width:450px;height:100px;" name="content_1"><?php echo ($vo["content_1"]); ?></textarea> -->
                        <P style="margin:5px 3px 10px"><?php echo ($vo["exper"]); ?></P>
                    </div>
                </div>
                ...
                <div class="form-group" style="">
                    ...
                    <div class="col-sm-4">
                        <p style="margin:4px 3px 10px"><img src="/Public<?php echo ($vo["img"]); ?>"  style="width:220px;height:295px;"/></p>
                    </div>
                </div>
