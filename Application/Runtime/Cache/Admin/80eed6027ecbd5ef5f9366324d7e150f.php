...
<html lang="en">
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="<?php echo U('New/save');?>" class="form-horizontal" enctype="multipart/form-data" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <textarea style="width:450px;height:100px;" name="content_1"><?php echo ($vo["content_1"]); ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="radio" name="seat" value="100" <?php if($vo["seat"] == 100): ?>checked<?php endif; ?>>100
                        <input type="radio" name="seat" value="400" <?php if($vo["seat"] == 400): ?>checked<?php endif; ?>>400
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="radio" name="type_id" value="0" <?php if($vo["type_id"] == 0): ?>checked<?php endif; ?>>公司新闻
                        <input type="radio" name="type_id" value="1" <?php if($vo["type_id"] == 1): ?>checked<?php endif; ?>>行业动态
                        <input type="radio" name="type_id" value="2" <?php if($vo["type_id"] == 2): ?>checked<?php endif; ?>>常见问题
                    </div>
                </div>
                ...
                <div class="form-group" style="">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div id="dd" style=" width:990px;"><img src="/Public<?php echo ($vo["img"]); ?>"  style="width:220px;height:165px;"/></div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <textarea style="width:450px;height:200px;" name="content_2"><?php echo ($vo["content_2"]); ?></textarea>
                    </div>
                </div>
