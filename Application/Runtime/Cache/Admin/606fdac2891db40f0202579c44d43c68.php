...
<html lang="en">
	...
	<div class="row">
		<div class="col-md-12">
			<form action="<?php echo U('Service/doadd');?>" method='post' class="form-horizontal" enctype="multipart/form-data">
				...
				<div class="form-group" style="">
					<label for="" class="col-sm-2 control-label">服务图片：</label>
					<div class="col-sm-4">
						<input type="file" name="img" class="" placeholder="">
						<p>(建议使用273*160，否则图片变形)</p>
					</div>
				</div>
