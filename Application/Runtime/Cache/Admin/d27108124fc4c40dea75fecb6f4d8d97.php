...
<html lang="en">
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="<?php echo U('Team/save');?>" class="form-horizontal" enctype="multipart/form-data" method="post">

                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">姓名 ：</label>
                    <div class="col-sm-4">
                        <input type="text" name="name" class="form-control" placeholder="" value="<?php echo ($vo["name"]); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="zhicheng" class="form-control" placeholder="" value="<?php echo ($vo["zhicheng"]); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="work_time" class="form-control" placeholder="" value="<?php echo ($vo["work_time"]); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <!-- <input type="text" name="fenge" class="form-control" placeholder="" value="<?php echo ($vo["fenge"]); ?>"> -->
                        <textarea style="width:450px;height:100px;" name="fenge"><?php echo ($vo["fenge"]); ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <textarea style="width:450px;height:100px;" name="exper"><?php echo ($vo["exper"]); ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <textarea style="width:450px;height:100px;" name="jianjie"><?php echo ($vo["jianjie"]); ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group" style="">
                    ...
                    <div class="col-sm-4">
                        <input type="file" name="img" id="doc" onchange="javascript:setImagePreviews();" />(建议使用220*295，否则图片变形)
                        <div id="dd" style=" width:990px;"><img src="/Public<?php echo ($vo["img"]); ?>"  style="width:220px;height:295px;"/></div>
                    </div>
                </div>
